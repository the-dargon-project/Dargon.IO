...
namespace Dargon.IO {
   public class DriveNodeIT : NMockitoInstance {
      ...
      private readonly DriveNodeFactory testObj;
      ...
      public void Run() {
         ...
         var node = testObj.CreateFromDirectory(testDataDirectory);
         ...
         var testFileDataSource = testFile.GetComponentOrNull<IDataSourceComponent>();
         ...
         foreach (var file in subdirectory2.Children) {
            var dataSource = file.GetComponentOrNull<IDataSourceComponent>();
